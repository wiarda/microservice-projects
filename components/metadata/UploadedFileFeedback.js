...
import { copyLink, resolveLink} from '../../helpers/helpers'
...
export default function UploadedFileFeedback(props){
    ...
    return (
        <React.Fragment>
            ...
            <div className="row mt-3"><a className="mx-auto" id="copy-link" href={props.link} /*download={props.name}*/>{link}</a></div>
